...
<div class="d-flex flex-wrap align-items-end justify-content-between mb-3 gap-2">
  <div>
    <h4 class="mb-1"><i class="bi bi-bar-chart-fill"></i> Executive Dashboard</h4>
    <div class="text-muted small">Snapshot for management · today <?= esc(date('d-m-Y')) ?></div>
  </div>
  <div class="d-flex gap-1">
    <a class="btn btn-sm btn-light" href="<?= site_url('reports/profitability') ?>"><i class="bi bi-bar-chart"></i> Profitability detail</a>
    <a class="btn btn-sm btn-light" href="<?= site_url('reports') ?>"><i class="bi bi-grid"></i> All reports</a>
  </div>
</div>
...
<!-- ─── Recent activity ─── -->
<div class="card">
  <div class="card-header"><i class="bi bi-activity"></i> Recent trip activity</div>
