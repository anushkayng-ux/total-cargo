<div class="d-flex justify-content-between align-items-center mb-3">
  <div>
    <h5 class="mb-1">Portal users</h5>
    <span class="text-muted" style="font-size:.9rem;">
      <?= esc($client['company_name']) ?>
      <?php if ((int) ($client['portal_enabled'] ?? 0) !== 1): ?>
        <span class="badge bg-warning text-dark ms-2">Portal disabled</span>
      <?php endif; ?>
    </span>
  </div>
  <a href="<?= site_url('clients/' . $client['id'] . '/edit') ?>" class="btn btn-sm btn-light">&larr; Back to client</a>
</div>
          ...
          <tbody>
            ...
            <?php foreach ($users as $u): ?>
              <tr>
                ...
                <td><?= (int) $u['status'] === 1 ? '<span class="badge bg-success">Active</span>' : '<span class="badge bg-secondary">Disabled</span>' ?></td>
