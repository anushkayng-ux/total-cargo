<div class="d-flex align-items-center gap-2 mb-3">
  <h5 class="m-0">Email Templates</h5>
  <a href="<?= site_url('email-templates/create') ?>" class="btn btn-sm btn-primary ms-auto"><i class="bi bi-plus-lg"></i> New template</a>
</div>

<div class="card">
  <div class="table-responsive">
    <table class="table table-sm align-middle mb-0" data-tpt-cols="email-templates">
      ...
      <?php foreach ($rows as $r): ?>
        <tr>
          ...
          <td data-col="status"><?= (int) $r['status'] === 1 ? '<span class="badge bg-success">Active</span>' : '<span class="badge bg-secondary">Disabled</span>' ?></td>
