...
?>
<?= tpt_toolbar([
    'new_href'       => site_url('dockets/create'),
    'new_item_label' => 'New Docket',
...
<div class="formwrap" style="flex:0 0 auto;padding-bottom:0;">
  <p class="text-muted mb-0" style="font-size:.9rem;">Every active trip whose LR / docket number hasn't been filled in yet — click a row to fill the docket.</p>
</div>

<div class="gridwrap">
  <div class="table-responsive">
    <table class="table grid mb-0" style="font-size:.9rem;" data-tpt-cols="dockets_pending">
      <thead>
        <tr>
      ...
      <tbody>
        ...
        <?php else: ?>
          <?php foreach ($rows as $r): ?>
            ...
            ?>
            <tr class="row-link" data-href="<?= site_url('dockets/create/' . (int) $r['id']) ?>">
              <td data-col="trip">
              ...
              <td data-col="action" class="text-end">
                <a href="<?= site_url('dockets/create/' . (int) $r['id']) ?>" class="btn btn-sm btn-primary">
