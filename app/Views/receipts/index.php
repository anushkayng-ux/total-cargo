<div class="d-flex align-items-center mb-3 gap-2 flex-wrap">
  ...
  <a class="btn btn-sm btn-outline-dark ms-auto" href="<?= site_url('receipts/import') ?>" title="Match bank-statement credits to invoices">
    <i class="bi bi-bank"></i> Bank import
  </a>
</div>
...
<form method="get" class="card mb-3"><div class="card-body p-3">
  <div class="row g-2 align-items-end">
    <div class="col-md-4"><label class="form-label" style="font-size:.72rem;text-transform:uppercase;letter-spacing:.04em;color:#6b7280;font-weight:600;">Search</label>
      <input class="form-control form-control-sm" type="text" name="q" value="<?= esc($filters['search'] ?? '') ?>" placeholder="Reference, client, invoice no, notes…"></div>
...
<div class="card">
  <div class="table-responsive">
    <table class="table mobile-cards mb-0" data-tpt-cols="receipts">
